...
namespace CodeCamp2016.iOS.Rest
{
    /// <summary>
	...
	public class RestCoreClient : IRestClient
    {
		...
		protected string StringContentType => "application/json";
		...
		/// <summary>
		/// Releases all resource used by the <see cref="T:CodeCamp2016.iOS.Rest.RestCoreClient"/> object.
		/// </summary>
		/// <remarks>Call <see cref="Dispose"/> when you are finished using the <see cref="T:CodeCamp2016.iOS.Rest.RestCoreClient"/>.
		/// The <see cref="Dispose"/> method leaves the <see cref="T:CodeCamp2016.iOS.Rest.RestCoreClient"/> in an unusable
		/// state. After calling <see cref="Dispose"/>, you must release all references to the
		/// <see cref="T:CodeCamp2016.iOS.Rest.RestCoreClient"/> so the garbage collector can reclaim the memory that the
		/// <see cref="T:CodeCamp2016.iOS.Rest.RestCoreClient"/> was occupying.</remarks>
		public void Dispose()
		{
			if (this.Client != null) {
				this.Client.Dispose ();
		...
		public async Task<T> PutAsync<T>(string address, object dto)
		{
			...
			return (T)await GetResponse<T>(response);
		}
